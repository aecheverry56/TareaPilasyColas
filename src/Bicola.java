...
public class Bicola<T> implements Iterable<T> {
    ...
    public static void main(String[] args) { Bicola<Integer> d = new Bicola<>(); d.agregar(2); d.agregar(3); d.agregarPrimero(1); System.out.println("Primero=" + d.tomar() + ", ultimo=" + d.ultimoElemento()); d.iteradorEnReversa().forEachRemaining(x -> System.out.print(x + " ")); }
}
